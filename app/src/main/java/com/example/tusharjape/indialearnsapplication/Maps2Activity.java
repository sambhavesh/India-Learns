...
public class Maps2Activity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    double beginLat, beginLong, endLat, endLong, flag = 0;
    String city;
    ...
    private String name, contact, starttime;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        proceedBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Maps2Activity.this, CenterListActivity.class);
    ...
    private void init(){
        ...
        mSearchText2.setOnItemClickListener(mAutocompleteClickListener2);
        ...
        mSearchText2.setAdapter(mPlaceAutocompleteAdapter2);
    ...
    private void geoLocate2(){
        ...
        if(list.size() > 0){
            ...
            moveCamera2(new LatLng(address.getLatitude(), address.getLongitude()), DEFAULT_ZOOM,
                    address.getAddressLine(0));
        }
    }
                ...
                location.addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(Maps2Activity.this, "unable to get current location", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
    ...
    private void moveCamera(LatLng latLng, float zoom, PlaceInfo placeInfo){
        ...
        mMap.setInfoWindowAdapter(new CustomInfoWindowAdapter(Maps2Activity.this));
        ...
        if(placeInfo != null){
            try{
                ...
                beginLat = latLng.latitude;
                beginLong = latLng.longitude;
    ...
    private void moveCamera2(LatLng latLng, float zoom, PlaceInfo placeInfo){
        Log.d(TAG, "moveCamera: moving the camera to: lat: " + latLng.latitude + ", lng: " + latLng.longitude );
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(latLng, zoom));
        ...
        if(placeInfo != null){
            try{
                ...
                MarkerOptions options = new MarkerOptions()
                        ...
                        .title(placeInfo.getName())
                        .snippet(snippet);
                Marker mMarker2 = mMap.addMarker(options);
    ...
    private void moveCamera2(LatLng latLng, float zoom, String title){
        Log.d(TAG, "moveCamera: moving the camera to: lat: " + latLng.latitude + ", lng: " + latLng.longitude );
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(latLng, zoom));
...
//                Log.d(TAG, "onResult: attributions: " + place.getAttributions());
                ...
                if(flag%2 == 0){
                    beginLat = place.getLatLng().latitude;
                    beginLong = place.getLatLng().longitude;
                    flag++;
                }
                else{
    ...
    private ResultCallback<PlaceBuffer> mUpdatePlaceDetailsCallback2 = new ResultCallback<PlaceBuffer>() {
        ...
        public void onResult(@NonNull PlaceBuffer places) {
            ...
            try{
                PlaceInfo mPlace2 = new PlaceInfo();
                mPlace2.setName(place.getName().toString());
                Log.d(TAG, "onResult: name: " + place.getName());
                mPlace2.setAddress(place.getAddress().toString());
                Log.d(TAG, "onResult: address: " + place.getAddress());
//                mPlace.setAttributions(place.getAttributions().toString());
//                Log.d(TAG, "onResult: attributions: " + place.getAttributions());
                mPlace2.setId(place.getId());
                Log.d(TAG, "onResult: id:" + place.getId());
                mPlace2.setLatlng(place.getLatLng());
                Log.d(TAG, "onResult: latlng: " + place.getLatLng());
                ...
                mPlace2.setRating(place.getRating());
                Log.d(TAG, "onResult: rating: " + place.getRating());
                mPlace2.setPhoneNumber(place.getPhoneNumber().toString());
                Log.d(TAG, "onResult: phone number: " + place.getPhoneNumber());
                mPlace2.setWebsiteUri(place.getWebsiteUri());
                Log.d(TAG, "onResult: website uri: " + place.getWebsiteUri());
            ...
            moveCamera2(new LatLng(place.getViewport().getCenter().latitude,
                    place.getViewport().getCenter().longitude), DEFAULT_ZOOM, mPlace);
